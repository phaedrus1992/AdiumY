...
- (void)testUniqueURI {
	...
	testHyperlink(@"ymsgr:im?to=adiumy");
	testHyperlink(@"yahoo:im?to=adiumy");
	//gtalk: URIs adapted from http://groups.google.com/group/google-talk-open/browse_thread/thread/8b297e26b4ffce1b/8d9f92f0f5e68a04?#8d9f92f0f5e68a04 and https://github.com/phaedrus1992/adiumy/ticket/7420#comment:4
