...
- (id)init
{
	if ((self = [super init])) {
		...
		OSStatus err = AudioObjectAddPropertyListener(kAudioObjectSystemObject, &audioAddress,
													  systemOutputDeviceDidChange, (__bridge void *)self);
...
#pragma unused(inAddresses)
	...
	@autoreleasepool {
		...
		NSCAssert1(self,
				   @"AudioHardware property listener function %s called with nil refcon, which we expected to be "
				   @"the AdiumSound instance",
				   __PRETTY_FUNCTION__);
