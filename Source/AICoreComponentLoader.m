...
- (void)loadComponents
{
	...
	NSArray *componentClassNames = [NSArray
		arrayWithObjects:@"AIAccountListPreferencesPlugin", @"AIAccountMenuAccessPlugin", @"AIAliasSupportPlugin",
						 ...
						 @"AIStatusChangedMessagesPlugin", @"AITabStatusIconsPlugin", @"BGEmoticonMenuPlugin",
						 @"CBActionSupportPlugin", @"CBContactCountingDisplayPlugin", @"CBContactLastSeenPlugin",
						 @"CBStatusMenuItemPlugin", @"DCInviteToChatPlugin", @"DCJoinChatPanelPlugin",
						 @"DCMessageContextDisplayPlugin", @"AIAddBookmarkPlugin", @"ESAccountEvents",
						 @"ESAccountNetworkConnectivityPlugin", @"ESAnnouncerPlugin",
						 ...
						 @"ESGeneralPreferencesPlugin", @"ESSecureMessagingPlugin", @"ESStatusPreferencesPlugin",
						 @"AIAutomaticStatus", @"ESAwayStatusWindowPlugin", @"RAFBlockEditorPlugin",
						 @"SMContactListShowBehaviorPlugin", @"ESiTunesPlugin", @"ESPersonalPreferencesPlugin",
						 @"AIXtrasManager", @"OWSpellingPerContactPlugin", @"GBQuestionHandlerPlugin",
						 @"AINulRemovalPlugin", @"AIDefaultFontRemovalPlugin", @"AIAdvancedPreferencesPlugin",
						 @"GBImportPlugin", @"AIMentionEventPlugin",
						 //		@"AILaconicaPlugin",
