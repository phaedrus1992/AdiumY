...
- (NSMenu *)_emoticonPackMenu
{
	...
	while ((pack = [enumerator nextObject])) {
		menuItem = [[NSMenuItem alloc] initWithTitle:[pack name] target:nil action:nil keyEquivalent:@""];
...
- (void)_addWindowStyleOption:(NSString *)option withTag:(NSInteger)tag toMenu:(NSMenu *)menu
{
	NSMenuItem *menuItem = [[NSMenuItem alloc] initWithTitle:option target:nil action:nil keyEquivalent:@""];
	[menuItem setTag:tag];
	[menu addItem:menuItem];
}
...
- (NSMenu *)_listLayoutMenu
{
	...
	while ((set = [enumerator nextObject])) {
		...
		menuItem = [[NSMenuItem alloc] initWithTitle:name target:nil action:nil keyEquivalent:@""];
...
- (NSMenuItem *)menuItemForIconPackAtPath:(NSString *)packPath class:(Class)iconClass
{
	...
	NSMenuItem *menuItem = [[NSMenuItem alloc] initWithTitle:name target:nil action:nil keyEquivalent:@""];
	[menuItem setRepresentedObject:name];
