 ...
 * for. This includes things like the adiumyextra:// installer, and twitterreply:// for the Twitter
 * service.
 *
...
{
	return [NSArray arrayWithObjects:@"twitterreply", @"adiumyextra", nil];
}
...
- (NSString *)defaultApplicationBundleIDForScheme:(NSString *)scheme
{
	NSURL *appURL = [[NSWorkspace sharedWorkspace]
		URLForApplicationToOpenURL:[NSURL URLWithString:[scheme stringByAppendingString:@":"]]];
