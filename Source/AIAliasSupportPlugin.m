...
- (void)uninstallPlugin
{
	...
	[adium.menuController removeMenuItem:menuItem_contactName];
	menuItem_contactName = nil;
}
...
- (NSMenu *)_contactNameMenu
{
	...
	menuItem = [[NSMenuItem alloc] initWithTitle:ALIAS target:self action:@selector(changeFormat:) keyEquivalent:@""];
