		...
		if ([inModifiedKeys containsObject:@"isOnline"]) {
			...
			if ([inObject boolValueForProperty:@"isOnline"]) {
				if (accountConnectionStatusGroupingOnlineTimer) {
					[accountConnectionStatusGroupingOnlineTimer invalidate]; accountConnectionStatusGroupingOnlineTimer = nil;
				}
				...
				if (accountConnectionStatusGroupingOfflineTimer) {
					[accountConnectionStatusGroupingOfflineTimer invalidate]; accountConnectionStatusGroupingOfflineTimer = nil;
				}
